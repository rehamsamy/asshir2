...
TextStyle _textStyle = TextStyle(
  fontFamily: Family.light,
    color: AppTheme.appBarTextColor, fontSize: 18, fontWeight: FontWeight.w700);
AppBar appBar(BuildContext context, String title,
    {Widget? action,bool leading =true}) {
  return AppBar(
    centerTitle: true,
    backgroundColor: AppTheme.appBarColorBase,
    elevation: 10,
   ...
   // actions: [action ?? Container()],
    actions: [
      Padding(
        ...
        child: SvgPicture.asset('assets/images/notification_appbar.svg',height: 30,
        width: 30,),
      ),
     ],
    leading: leading ? _leadingIcon(context) : Builder(builder: (context) => // Ensure Scaffold is in context
  IconButton(
